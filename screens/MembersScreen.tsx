...
const MembersScreen: React.FC = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-slate-800 mb-6">Administrar Miembros</h1>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-slate-50">
              <tr>
                <th className="p-4 text-sm font-semibold text-slate-600">Miembro</th>
            ...
            {otherMembers.length === 0 && (
                <p className="text-center text-slate-500 py-8">No hay otros miembros registrados.</p>
            )}
        </div>
      </div>
